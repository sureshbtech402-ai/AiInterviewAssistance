...
TASK:
Answer this architecture, framework, or project flow question in 4 to 6 natural spoken sentences as the candidate in an Indian corporate interview.
...
- Layer / Component Interaction: In 2-3 sentences, briefly connect only the relevant layers (e.g., Feature files -> Step definitions -> Page Objects -> Utilities/Reports -> Jenkins CI/CD).
...
- Keep it concise (under 75 words) so it can be spoken in 30-40 seconds.
